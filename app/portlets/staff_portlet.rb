class StaffPortlet < Portlet
  ...
  has_one :site_parameter_partial, :through => :parameter_partial_associations, :foreign_key => "mindbody_portlet_id"
  has_many :staff_parameter_partials, :through => :parameter_partial_associations, :foreign_key => "mindbody_portlet_id"
