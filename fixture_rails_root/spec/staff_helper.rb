...
module StaffHelper
	...
	def mock_service	
		...
		src_creds = Mb::SourceCredentials.new("SiteSrc", "password", 1)
		site_pp = mock_model "SiteParameterPartial"
		site_pp.stub!(:options).and_return(src_creds)

		SiteParameterPartial.stub!(:find).and_return(site_pp)
		
		staff_service = mock "Mb::StaffService" #Mock the instance to be created
